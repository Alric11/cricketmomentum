...
LIVE_CSV = "converted_match_innings1_over10.csv"  # Live match CSV
TEAM_CSV = "team.csv"                             # Starting XI CSV

# Default team names (these can be overridden by TEAM_CSV)
...
def compute_live_features(df, total_balls=TOTAL_BALLS):
    ...
    # Create "Over" and "Ball" if missing (from index)
...
# ----- GPT RECOMMENDATION FUNCTION (per inning) -----
...
# =============================================================================
# MAIN PIPELINE: Produce JSON output (without Flask)
# =============================================================================
if __name__ == "__main__":
    try:
        ...
        # Split into innings if available.
        if "Innings" in df_live.columns:
        ...
        # Generate structured reports for each inning.
        ...
        # Generate text summaries for GPT recommendations.
        ...
        # Generate GPT recommendations for each inning.
        ...
        # Extract momentum scores from structured reports.
        momentum_inn1 = structured_inning1.get("momentum", None)
        momentum_inn2 = structured_inning2.get("momentum", None)

        # Optionally compute an overall momentum (average of both innings if available).
